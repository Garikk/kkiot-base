...
public final  class WM_KKMasterConsts {
    ...
    public final static String WEBMASTER_N_REQUEST_GET_SYSSTATE = "system_state";           //check server available
    public final static String WEBMASTER_N_REQUEST_GET_MYCONF_INFO = "configuration_info";           //get ctrlr configuration, ID, stamp
    public final static String WEBMASTER_N_REQUEST_GET_MYCONF_DATA = "configuration_data";           //get ctrlr configuration
    public final static String WEBMASTER_N_REQUEST_GET_PLUGINS_INFO = "plugins_info";          //get plugins id, version and config stamp
    public final static String WEBMASTER_N_REQUEST_GET_PLUGINS_DATA = "plugins_info";          //get extended plugins info (with file names)
    public final static String WEBMASTER_N_REQUEST_GET_FILES_INFO_BIN = "files_bin_info";          //get extended plugins info (with file names)
    public final static String WEBMASTER_N_REQUEST_GET_FILES_INFO_EXTCONF = "files_exc_info";          //get extended plugins info (with file names)
    public final static String WEBMASTER_N_REQUEST_CTRLR_DATA_KKPIN = "pin_exchange";               //KKSystem PIN
